    ...
    <div class="pb-20 pt-20">
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white shadow-md p-3">
                <img class=" w-full" :src="campaign.image">
                ...
                <div v-if="maxDate(campaign.max_date) == true">
                    <div class="mt-5">
                        <button
                            class="bg-gray-500 py-3 rounded-md shadow-md text-xl w-full uppercase font-bold focus:outline-none opacity-50 cursor-not-allowed">Donasi
                            Ditutup!</button>
                    </div>
                </div>
                <div v-else>
                    <div class="mt-5">
                        <router-link :to="{ name: 'donation.create', params: { slug: route.params.slug } }">
                            <button
                                class="bg-gray-500 py-3 rounded-md shadow-md text-md w-full text-white font-bold focus:outline-none focus:bg-gray-600">Donasi
                                Sekarang!</button>
                        </router-link>
                    </div>
                </div>
        ...
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div class="bg-gradient-to-r from-blue-400 to-purple-600 p-4 rounded-lg shadow-lg mb-6">

                    <div class="grid grid-cols-10 gap-4 items-center">
                        <div class="col-span-2">
                            <img :src="user.avatar" class="w-20 h-20 rounded-full shadow-md border-4 border-white">
                        </div>
                        <div class="col-span-8">
                            <div class="text-white text-2xl font-semibold mt-2">
                                {{ user.name }}
                            </div>
                        </div>
                    </div>
        ...
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            ...
            <div class="bg-white rounded-md shadow-md p-3">
                ...
                <div class="border-2 border-gray-200 text-sm mt-3 mb-2"></div>
